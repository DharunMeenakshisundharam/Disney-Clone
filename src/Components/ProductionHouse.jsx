...
function ProductionHouse() 
{
  ...
  return (
    ...
    (
        <div className=' border-[2px] border-grey-600 rounded-lg hover:scale-100 transition-all duration-300 ease-in-out cursor-pointer relative shadow-xl shadow-black'>
